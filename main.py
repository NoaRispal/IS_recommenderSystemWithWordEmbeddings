...
def main(data,weights={'cb': 0.9, 'cf': 0.1}):
    DATA_DIR = "data/training"
    TUTORS_CSV = f"{DATA_DIR}/tutors.csv"
    RATINGS_CSV = f"{DATA_DIR}/ratings.csv"
    
    MODEL_W2V = "models/tutor_w2v.model"
    PROFILES_NPY = "models/tutor_profiles.npy"
    ...
    if os.path.exists(RATINGS_CSV):
        ...
        print(f"Attention : {RATINGS_CSV} introuvable. Le CF ne fonctionnera pas.")
